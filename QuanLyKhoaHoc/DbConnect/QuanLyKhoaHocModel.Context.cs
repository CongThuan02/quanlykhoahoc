...
namespace QuanLyKhoaHoc.DbConnect
{
    ...
    public partial class QuanLyKhoaHocEntities : DbContext
    {
        public QuanLyKhoaHocEntities()
            : base("name=QuanLyKhoaHocEntities")
        {
        }
        ...
        public virtual DbSet<HoiNghiKhoaHoc> HoiNghiKhoaHocs { get; set; }
