...
namespace QuanLyKhoaHoc.QuanLyDoAnTotNghiep.CanBo
{
    public partial class fGiangVienHD : Form
    {
        ...
        private async void fGiangVienHD_Load(object sender, EventArgs e)
        {
            await loadingdata();
        ...
        private void cbSinhVien_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtTenSv.Text = current.GetType().GetProperty("hoTen").GetValue(current, null).ToString();
        }
        ...
        private void lsCanBo_Click(object sender, EventArgs e)
        {
